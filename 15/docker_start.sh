...
# стартуем докер
docker run --rm --name my_postgres_15 --shm-size 2147483648 -p 5433:5432/tcp --stop-timeout 60 \
           -v /var/lib/pgsql/15_1/data:/var/lib/postgresql/data \
           -v /var/log/postgresql1:/var/log/postgresql \
           -v /mnt/pgbak2/:/mnt/pgbak \
           -v /usr/share/postgres/15_1/tsearch_data:/usr/share/postgresql/tsearch_data \
