...
if ! docker image ls | grep "grufos/postgres" ; then
    ...
    docker tag grufos/postgres:latest grufos/postgres:14.3
    docker push grufos/postgres:14.3
fi
...
if ! docker image ls | grep "grufos/pganalyze" ; then
    ...
    docker tag grufos/pganalyze:latest grufos/pganalyze:14.3
    docker push grufos/pganalyze:14.3
fi
...
if ! docker image ls | grep "grufos/pgprobackup" ; then
    ...
    docker tag grufos/pgprobackup:latest grufos/pgprobackup:14.3_2.5.5
    docker push grufos/pgprobackup:14.3_2.5.5
fi
...
if ! docker image ls | grep "grufos/pgprorestore" ; then
    ...
    docker tag grufos/pgprorestore:latest grufos/pgprorestore:14.3_2.5.5
    docker push grufos/pgprorestore:14.3_2.5.5
fi
