...
#    echo "    push ..."
#    docker tag 13_pgbouncer:latest grufos/pgbouncer:latest
...
#    docker push grufos/postgres:latest
    docker tag grufos/postgres:latest grufos/postgres:13.9
    docker push grufos/postgres:13.9
fi
...
#    docker push grufos/pganalyze:latest
    docker tag grufos/pganalyze:latest grufos/pganalyze:13.9
    docker push grufos/pganalyze:13.9
fi
...
#    docker push grufos/pgprobackup:latest
    docker tag grufos/pgprobackup:latest grufos/pgprobackup:13.9_2.5.8
    docker push grufos/pgprobackup:13.9_2.5.5
fi
...
#    docker push grufos/pgprorestore:latest
    docker tag grufos/pgprorestore:latest grufos/pgprorestore:13.9_2.5.8
    docker push grufos/pgprorestore:13.9_2.5.8
fi
...
if ! docker image ls | grep "grufos/mamonsu" ; then
    echo "    push ..."
    docker tag 13_mamonsu:latest grufos/mamonsu:latest
#    docker push grufos/mamonsu:latest
    docker tag grufos/mamonsu:latest grufos/mamonsu:13_3.5.2
    docker push grufos/mamonsu:13_3.5.2
fi
