...
with pg_stat_statements_slice as (
  ...
  select
    ...
    avg(stddev_exec_time) as stddev_exec_time
  ...
  select
    ...
    min_exec_time::numeric(20, 2) as min_time,
    max_exec_time::numeric(20, 2) as max_time,
    stddev_exec_time::numeric(20, 2) as stddev_time,
    database,
    username,
    query
  ...
  select
    ...
    (min(min_exec_time))::numeric(20, 2) as min_time,
    (max(max_exec_time))::numeric(20, 2) as max_time,
    (avg(stddev_exec_time))::numeric(20, 2) as stddev_time,
    'all' as database,
    'all' as username,
    'other' as query
  from _pg_stat_statements
...
select
  e'=============================================================================================================\n'
  || 'pos:' || pos || E'\t total time: ' || total_exec_time || ' (' || time_percent  || ', CPU: ' || cpu_time_percent || ', IO: ' || io_time_percent 
